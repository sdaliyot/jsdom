  ...
  const getClientRedirectListener = (xhrInstanceId) => {
    return () => {
      try {
        ...
        console.warn('XHR failed to handle client redirect event: %o', err);
      }
    };
  };
  ...
  const getClientResponseListener = (xhrInstanceId) => {
    return (response) => {
      try {
        ...
        console.warn('XHR failed to handle client response event: %o', err);
      }
    };
  };
  ...
  const getResponseDataListener = (xhrInstanceId) => {
    return (chunk) => {
      try {
        ...
        console.warn('XHR failed to handle response data event: %o', err);
      }
    };
  };
  ...
  const getClientDataListener = (xhrInstanceId) => {
    return (chunk) => {
      try {
        ...
        console.warn('XHR failed to handle client data event: %o', err);
      }
    };
  };
  ...
  const getClientEndListener = (xhrInstanceId) => {
    return () => {
      try {
        ...
        console.warn('XHR failed to handle client end event: %o', err);
      }
    };
  };
  ...
  const getClientErrorListener = (xhrInstanceId) => {
    return (err) => {
      try {
        ...
        console.warn('XHR failed to handle client error event: %o', err);
      }
    };
  };
    ...
    return (req) => {
      req.on("response", () => {
        try {
          ...
          console.warn('XHR failed to handle client request response event: %o', err);
        }
      });
    };
  };
